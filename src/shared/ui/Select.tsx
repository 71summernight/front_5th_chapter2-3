...
// -------------- Types --------------
type TriggerProps = SelectPrimitive.SelectTriggerProps
type ContentProps = SelectPrimitive.SelectContentProps
...
const SelectTrigger = forwardRef<HTMLButtonElement, TriggerProps>(({ className, children, ...props }, ref) => (
...
const SelectItem = forwardRef<HTMLDivElement, ItemProps>(({ className, children, ...props }, ref) => (
